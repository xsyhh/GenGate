...
def main():
    ...
    p.add_argument("--actor_samples_path", type=str, default="llama/code/output/llama3_8b_actor_samples.jsonl")
    p.add_argument("--expert_csv_path", type=str, default="expert_output/code/expert_results.csv")
    p.add_argument("--output_path", type=str, default="llama/code/output/llama3_8b_validation_results.jsonl")
    p.add_argument(
        "--raw_csv_paths",
        nargs="+",
        default=[
