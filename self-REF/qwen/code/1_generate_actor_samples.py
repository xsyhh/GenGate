...
def main():
    ...
    p.add_argument("--model_path", type=str, default="Qwen2.5-Coder-3B-Instruct")
    p.add_argument("--output_path", type=str, default="qwen/code/output/3B_actor_samples.jsonl")
