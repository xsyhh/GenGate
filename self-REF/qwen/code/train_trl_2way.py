...
def main():
    ...
    # --- 1. 路径配置 ---
    model_path = "qwen-Coder-3b_with_Expert_Direct"
    dataset_path = "qwen/code/output/trl_sft_data_2way.jsonl"
    output_dir = "qwen/code/ckpt/qwen_code_only_decision_1ep_r0.8"
    ...
    # --- 7. LoRA 配置 ---
    # QKV LoRA only. Decision token embedding/head rows are trained directly
    # with gradient masks after the PEFT wrapper is constructed.
