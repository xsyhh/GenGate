...
def main() -> None:
    ...
    p.add_argument("--actor_samples_jsonl", type=str, default="qwen/math/output/step1.jsonl")
    p.add_argument("--data_jsonl", type=str, default="data/MATH/hendrycks_math_train.jsonl")
    p.add_argument("--output_jsonl", type=str, default="qwen/math/output/step2.jsonl")
