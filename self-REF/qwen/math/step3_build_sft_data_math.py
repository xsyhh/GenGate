...
def main() -> None:
    ...
    p.add_argument("--validation_jsonl", type=str, default="qwen/math/output/step2.jsonl")
    p.add_argument("--model_path", type=str, default="Qwen2.5-3B-Instruct")
    p.add_argument("--output_jsonl", type=str, default="qwen/math/output/step3.jsonl")
